...
const ContactCard = ({
  ...
  <div
    className="p-6 rounded-sm border transition-all duration-300 hover:border-[hsl(43,74%,66%,0.4)]"
    style={{ borderColor: "hsl(43,20%,18%)", background: "hsl(20,10%,9%)" }}
  >
    <div className="flex items-start gap-4">
      <div
        className="w-12 h-12 rounded-full flex items-center justify-center shrink-0 font-serif-display text-lg"
        style={{ background: "hsl(43,74%,66%,0.12)", color: "hsl(43,74%,66%)" }}
      >
        {name[0]}
      </div>
      <div>
        <h3 className="font-serif-display font-light text-lg" style={{ color: "hsl(45,80%,90%)" }}>
          {name}
        </h3>
        <p className="text-xs font-sans-light tracking-widest uppercase mb-3" style={{ color: "hsl(43,50%,50%)" }}>
          {role}
        </p>
        <div className="flex items-center gap-2">
          <Icon name="Phone" size={14} style={{ color: "hsl(43,74%,66%)" }} />
          <a
            href={`tel:${phone}`}
            className="text-sm font-sans-light transition-colors duration-300 hover:text-[hsl(43,74%,66%)]"
        ...
        {whatsapp && (
          <div className="flex items-center gap-2 mt-1">
            <Icon name="MessageCircle" size={14} style={{ color: "hsl(43,74%,66%)" }} />
            <a
    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div
          ...
          style={{ borderColor: "hsl(43,20%,18%)", background: "hsl(20,10%,9%)" }}
        >
          <p className="text-xs tracking-[0.3em] uppercase mb-1 font-sans-light" style={{ color: "hsl(43,50%,50%)" }}>
            Организатор свадьбы
          </p>
          <p className="font-serif-display font-light text-xl mb-1" style={{ color: "hsl(45,80%,90%)" }}>
            Мария Соколова
          </p>
        ...
        <div className="mt-16 pt-10 border-t text-center" style={{ borderColor: "hsl(43,20%,16%)" }}>
          <p
          ...
          <p className="text-xs font-sans-light tracking-widest uppercase" style={{ color: "hsl(45,15%,35%)" }}>
            Антуан де Сент-Экзюпери
          </p>
          <div className="mt-8 flex items-center justify-center gap-3">
            <div className="h-px w-12" style={{ background: "hsl(43,74%,66%,0.3)" }} />
            <svg width="16" height="16" viewBox="0 0 16 16">
              <path d="M8 0 L9.4 5.8 L15.5 8 L9.4 10.2 L8 16 L6.6 10.2 L0.5 8 L6.6 5.8 Z" fill="hsl(43,74%,66%)" fillOpacity="0.5" />
            </svg>
            <div className="h-px w-12" style={{ background: "hsl(43,74%,66%,0.3)" }} />
          </div>
