    ...
    >
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{ background: "hsl(43,74%,66%,0.04)" }}
        />
        <div
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1000 700" preserveAspectRatio="xMidYMid slice">
          <rect x="150" y="50" width="700" height="600" rx="2" stroke="hsl(43,74%,66%)" strokeWidth="0.5" strokeOpacity="0.08" fill="none" />
          <rect x="170" y="70" width="660" height="560" rx="2" stroke="hsl(43,74%,66%)" strokeWidth="0.3" strokeOpacity="0.05" fill="none" />
          <line x1="0" y1="350" x2="1000" y2="350" stroke="hsl(43,74%,66%)" strokeWidth="0.3" strokeOpacity="0.05" />
          <line x1="500" y1="0" x2="500" y2="700" stroke="hsl(43,74%,66%)" strokeWidth="0.3" strokeOpacity="0.05" />
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6">
        ...
        {submitted ? (
          <div
            ...
            style={{ borderColor: "hsl(43,74%,66%,0.3)", background: "hsl(43,74%,66%,0.04)" }}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                onBlur={(e) => Object.assign(e.target.style, { borderColor: "hsl(43,20%,22%)" })}
                required
              />
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {(["yes", "no"] as AttendStatus[]).map((val) => (
                  <button
                    ...
                    style={{
                      border: `1px solid ${attend === val ? "hsl(43,74%,66%)" : "hsl(43,20%,22%)"}`,
                      background: attend === val ? "hsl(43,74%,66%,0.15)" : "transparent",
                      color: attend === val ? "hsl(43,74%,66%)" : "hsl(45,15%,55%)",
                      borderRadius: "2px",
                    }}
                  >
            ...
            {attend === "yes" && (
              <div>
                ...
                >
                  {["1", "2", "3", "4"].map((n) => (
                    <option key={n} value={n} style={{ background: "hsl(20,10%,10%)" }}>
                      {n} {n === "1" ? "гость" : "гостя"}
                    </option>
                  ))}
                </select>
            ...
            <button
              ...
              style={{
                background: "linear-gradient(135deg, hsl(43,74%,56%), hsl(43,74%,66%))",
                color: "hsl(20,14%,6%)",
                borderRadius: "2px",
                fontWeight: 500,
              }}
